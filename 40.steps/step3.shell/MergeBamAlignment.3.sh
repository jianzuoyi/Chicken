...
java -Dsamjdk.compression_level=5 -Xms3000m -jar /its1/GB_BT2/jianzuoyi/biosoft/gatk-4.0.0.0/picard.jar \
  ...
  ALIGNED_BAM=/its1/GB_BT2/jianzuoyi/projects/Chicken/20.processing_for_gatk/BAMs/3/3.unmapped.bam.unmerged.bam \
  UNMAPPED_BAM= /its1/GB_BT2/jianzuoyi/projects/Chicken/20.processing_for_gatk/BAMs/3/3.unmapped.bam \
  OUTPUT=/its1/GB_BT2/jianzuoyi/projects/Chicken/20.processing_for_gatk/BAMs/3/3.unmapped.aligned.unsorted.bam \
