...
java -Dsamjdk.compression_level=5 -Xms4000m -jar /its1/GB_BT2/jianzuoyi/biosoft/gatk-4.0.0.0/picard.jar \
  SortSam \
  INPUT=/its1/GB_BT2/jianzuoyi/projects/Chicken/20.processing_for_gatk/BAMs/9/9.aligned.unsorted.duplicates_marked.bam \
  OUTPUT=/dev/stdout \
...
java -Dsamjdk.compression_level=5 -Xms500m -jar /its1/GB_BT2/jianzuoyi/biosoft/gatk-4.0.0.0/picard.jar \
  SetNmAndUqTags \
  INPUT=/dev/stdin \
  OUTPUT=/its1/GB_BT2/jianzuoyi/projects/Chicken/20.processing_for_gatk/BAMs/9/9.aligned.duplicate_marked.sorted.bam \
  CREATE_INDEX=true \
