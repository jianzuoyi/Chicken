...
/its1/GB_BT2/jianzuoyi/biosoft/speedseq/bin/speedseq align \
    ...
    /its1/GB_BT2/jianzuoyi/projects/Chicken/20.processing_for_gatk/merge_data/8/8_1.fq.gz \
    /its1/GB_BT2/jianzuoyi/projects/Chicken/20.processing_for_gatk/merge_data/8/8_2.fq.gz
# Example speedseq commands on a small slice of chromosome 20
