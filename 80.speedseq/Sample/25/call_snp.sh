...
/its1/GB_BT2/jianzuoyi/biosoft/speedseq/bin/speedseq align \
    ...
    /its1/GB_BT2/jianzuoyi/projects/Chicken/20.processing_for_gatk/merge_data/25/25_1.fq.gz \
    /its1/GB_BT2/jianzuoyi/projects/Chicken/20.processing_for_gatk/merge_data/25/25_2.fq.gz
# Example speedseq commands on a small slice of chromosome 20
